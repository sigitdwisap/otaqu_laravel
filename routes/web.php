...
Route::get('/employee_json', [EmployeesController::class, 'json'])->name('employee.json');
...
Route::post('/employee/{id}', [EmployeesController::class, 'update'])->name('employee.update');

// DELETE
Route::get('employee/delete/{id}', [EmployeesController::class, 'destroy'])->name('employee.destroy');
...
// Route::get('/json', [EmployeesController::class, 'json'])->name('employee.json');
